...
class PTagCloud
{
    ...
    function keywords_extract($text)
    {
        ...
        $commonWords = "'tis,'twas,a,able,about,across,after,ain't,all,almost,also,am,among,an,and,any,are,aren't," .
            ...
            "often,on,only,or,other,one,our,own,rather,said,say,says,shan't,she,she'd,she'll,she's,should,should've," .
            "s,shouldn't,since,so,some,than,that,that'll,that's,the,their,them,then,there,there's,these,they,they'd," .
            "they'll,they're,they've,this,tis,to,too,twas,unit,us,wants,was,wasn't,we,we'd,we'll,we're,were,weren't,what," .
    ...
    function addTagsFromTitle($SeedTitle)
    {
        $words = $this->keywords_extract($SeedTitle);
		foreach ($words as $key => $value)
		{
			$this->addTag($value, 2);
		}
